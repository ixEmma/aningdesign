...
|-----------|--------------------------|---------------------------------------|---------|
| `primary` | `.aning-button--primary` | Brand gradient, dark text             | Highest-priority actions only (hero, final CTA, mid-page strip) |
...
| `flatSurfaces: true`                    | Flat (no-gradient) surfaces | Adds `.service-page--flat`, which replaces gradient **surfaces** with solid/tonal colour: the page + hero backgrounds, the mid-CTA panel, and the shared 145° card gradient. It does not recolour the locked shared primary CTA. Opt-in and isolated. |
