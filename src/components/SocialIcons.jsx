/* Shared real brand icons for social links.
 * Used by Footer, MegaMenu, Contact, and Hero so every social link
 * renders the real logo. Each svg uses fill="currentColor" so it inherits
 * the link colour; size is controlled by each consumer's CSS. */
